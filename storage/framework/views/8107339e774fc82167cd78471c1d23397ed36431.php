                ...
                <div class="card card-outline card-info">
                    <div class="card-header">
                        ...
                        <div class="float-sm-right">
                            <a class="btn btn-primary btn-sm box-tools" href="/dashboardadmin/event/new">
...
$(document).ready(function () {
    ...
    table = $('#tb-event').DataTable({
        ...
        serverSide: true,
        processing: false,
        ajax: '/dashboardadmin/event/view',
        columns: [
...
$.ajax({
    type: 'POST',
    url: '/dashboardadmin/event/destroy',
    data: {
        _method: 'DELETE',
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\simpoku\resources\views/admin/master/event/page.blade.php ENDPATH**/ ?>