        ...
        <div class="row justify-content-center">
            <div class="col-md-11">
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        {{ csrf_field() }}
                    <input type="hidden" name="oldid" value="{{$banner->id}}">
                         <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="jenis">Banner Type</label>
                                    <select id="jenis" class="form-control" name="jenis">
                                        <option value="event" {{ $banner->jenis == 'event' ? 'selected' : ''}}>Event</option>
                                        <option value="iklan" {{ $banner->jenis == 'iklan' ? 'selected' : ''}}>Iklan</option>
                                    </select>
                                </div>
                                    <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('idEvent') is-invalid @enderror" placeholder="Event ID" id="idEvent" name="idEvent" value="{{ old('judul', $banner->idEvent)}}" readonly onclick="openModal()">
                                            </div>
                                    </div>
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror" placeholder="Banner Title" id="judul" name="judul" value="{{ old('judul', $banner->judul)}}">
                                        @error('judul')
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="terlihat" class="form-control" name="terlihat">
                                        <option value="ya" {{ $banner->terlihat == 'ya' ? 'selected' : '' }}>Visible</option>
                                        <option value="tidak" {{ $banner->terlihat == 'tidak' ? 'selected' : '' }}>Invisible</option>
                                    </select>
                                </div>
                            </div>
                         </div>
